...
public class SystemServiceImpl implements ISystemService{
    ...
    public System findOne(String name) {
        System usu = systemRepository.findSystemByName(name);
        if (usu == null) {
            throw new UsernameNotFoundException(String.format("Usuário (%s) não encontrado!",name));
        }
        return usu;
    }
